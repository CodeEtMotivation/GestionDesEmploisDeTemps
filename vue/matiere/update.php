           <?php 
            ...
            $datas=$matieredb->read($idmatiere);
    ...
    <section class="panel" style="margin-top: 150px;">  
                  ...
                  <div class="panel-body table-responsive">
                      <form method="post" action="controler/matierecontroler.php?action=update">
                            ...
                            <input type="hidden" name="idmatiere" value="<?=$idmatiere;  ?>">
                              ...
                              <p class="field">
                                  ...
                                  <input type="text" name="intitule" id="intitule" class="form-control" value="<?=$datas->intitule;  ?>" required/>
                              </p>
                              <p>
