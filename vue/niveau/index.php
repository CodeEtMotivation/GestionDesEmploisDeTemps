  ...
  <section class="panel" style="margin-top: 30px;">    
                  <div class="panel-head">
                    <div class="float-left ml-3 mt-3">
                      <h4>Listes des Niveaux</h4>
                    </div>
                    <div class="float-right" style="display: non;">
                      <a href="app.php?view=niveau_create">
                        <?php 
                       ...
                       <tbody>
                        <?php 
                            ...
                            foreach ($datas as $lignes) {
                              ...
                              $update="app.php?view=niveau_update&id_niveau=".$lignes->id_niveau;
                              $delete="app.php?view=niveau_delete&id_niveau=".$lignes->id_niveau;
